    ...
    return (
      <button
        ...
        className={cn(
          ...
          variant === "default" && "border border-white/80 bg-primary text-primary-foreground shadow-[0_10px_28px_rgba(255,255,255,0.10)] hover:bg-primary/90 hover:shadow-[0_14px_34px_rgba(255,255,255,0.14)]",
          ...
          variant === "destructive" && "border border-white/20 bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",

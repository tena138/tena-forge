...
const sections = [
  {
    title: "1. 배송 안내",
    body: [
      "본 서비스는 디지털 서비스로서 실물 상품이 배송되지 않습니다. 무료 가입만으로는 유료 기능, AI credits, 문항 추출 권한이 부여되지 않으며, 결제수단 등록 후 회사가 정한 절차에 따라 계정 내 서비스 이용 권한이 부여됩니다.",
    ],
  },
  {
    title: "2. 교환 안내",
  ...
  },
  {
    ...
    body: [
      "월간 구독은 결제수단 등록 완료 시 7일 무료 체험이 시작되고, 첫 자동결제는 무료 체험 종료 후 등록된 결제수단으로 진행됩니다.",
  ...
  },
  {
    ...
    body: [
      "회원은 무료 체험 종료일 또는 다음 결제일 전까지 구독을 해지할 수 있습니다. 구독을 해지하면 이후 자동결제가 중단되며, 이미 결제된 이용 기간 동안에는 서비스를 계속 이용할 수 있습니다.",
